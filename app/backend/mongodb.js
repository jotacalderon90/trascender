...
let self = function(application,params){
	...
	this.collection_name	= (params[1]!=undefined)?params[1]:undefined;
	this.view_doc			= (params[2]!=undefined)?params[2]:undefined;
	this.view_coll			= (params[3]!=undefined)?params[3]:undefined;
	this.match				= (params[4]!=undefined)?params[4]:undefined;
	this.sort				= (params[5]!=undefined)?params[5]:undefined;
