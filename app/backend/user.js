...
//@method(['get'])
//@roles(['user'])
self.prototype.render_info = async function(req,res){
	try{
...
self.prototype.create = async function(req,res){
	try{
		...
		res.render("message",{title: "Usuario registrado", message: "Se ha completado su registro correctamente", class: "success", config: this.config});
	}catch(e){
		console.log(e);
		res.status(500).render("message",{title: "Error en el Servidor", message: e.toString(), error: 500, class: "danger", config: this.config});
	}
...
//@route('/api/user/desactivate/:hash')
//@method(['get'])
